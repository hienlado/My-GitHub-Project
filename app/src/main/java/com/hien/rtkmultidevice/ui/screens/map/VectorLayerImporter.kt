...
object VectorLayerImporter {
    ...
    // HOÀN NGUYÊN (2026): khôi phục dấu gốc RY, RZ (đồng bộ HelmertTransform) — mốc thật gần hơn.
    private val H_RX =  0.00928836 * (PI / 648000.0)   // ω0
    private val H_RY = -0.01975479 * (PI / 648000.0)   // ψ0
    private val H_RZ =  0.00427372 * (PI / 648000.0)   // ε0
